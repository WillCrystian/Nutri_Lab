...
# A linha abaixo só deixa a função abaixo dela funcionar se o usuário estiver logado
...
def pacientes(request):
    if request.method == "GET":
        ...
        # armazenando todos pacientes cadastrado
...
def dados_paciente(request, id):
    # verifica se existe paciente cadastrado, caso não Erro 404
